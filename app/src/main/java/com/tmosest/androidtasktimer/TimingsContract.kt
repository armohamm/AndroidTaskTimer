...
object TimingsContract {
    ...
    private val CONTENT_URL : Uri = Uri.withAppendedPath(CONTENT_AUTHORITY_URI, TABLE_NAME)

    const val CONTENT_TYPE = "vnd.android.cursor.div/vnd.$CONTENT_AUTHORITY.$TABLE_NAME"
